...
interface CreateCollectionFormProps {
    open: boolean;
    newCollectionClick: () => void;
    fetchCollections: () => Promise<{ id: string; [key: string]: any }[]>;
    setCollections: (collections: { id: string; [key: string]: any }[]) => void;
}

const CreateCollectionForm: React.FC<CreateCollectionFormProps> = ({open, newCollectionClick, fetchCollections, setCollections}) => {
            ...
            <Dialog open={open} fullWidth PaperProps={{
                ...
                >
                    ...
                    <Box component="form" sx={{
                        ...
                        <TextField label="Name" variant="outlined" onChange={(e) => setCollectionName(e.target.value)} sx={inputStyles}/>
                        <TextField label="Flashcards Description" rows={4} multiline onChange={(e) => setDescription(e.target.value)} variant="outlined" sx={inputStyles}/>
                        <Box
                            sx={{
                                display: 'flex',
